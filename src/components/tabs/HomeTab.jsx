...
export default function HomeTab({ session, onGroupSelect, onSignOut, onProfilePress, onTabChange, scrollToChatRef, onOpenDMs, onStartDM }) {
  ...
  const S = {
    ...
    wlPopChip: {
      ...
      background: t.greenBg, border: '1px solid rgba(26,173,94,0.2)',
    ...
    stocksBtn: {
      ...
      cursor: 'pointer', border: '1px solid #8cd9a0', background: t.greenBg,
    ...
    siAddBtnLight: {
      fontSize: 12, fontWeight: 600, color: t.green, background: t.greenBg,
                        ...
                        >
                          {isMyList ? (
                            <>
                              ...
                              <span
                                style={{ width: 24, textAlign: 'center', fontSize: 14, color: t.border, cursor: 'pointer' }}
                            ...
                            <>
                              ...
                              <span style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 3 }}>
                                ...
                                <span style={{ fontSize: 10, color: t.border }}>{isOpen ? '▲' : '▼'}</span>
                              </span>
                              <span style={{ width: 60, textAlign: 'right', fontSize: 11, color: t.text3 }}>
                                {priceData ? `$${priceData.price.toFixed(2)}` : '—'}
                              </span>
