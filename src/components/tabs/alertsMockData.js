...
export const MOCK_ALERTS = [
  ...
  { id: 'mock-8', ticker: 'META', name: 'Meta Platforms',           alert_type: 'ma_cross',  price: 527.40, change: 1.22, volume: '12.1M',  time: '1:42 PM',   timeGroup: 'afternoon',  signal: '9MA $512.88 crossed above 21MA $498.33',     confidence: 68, support: 498.00, resistance: 545.00, sector: 'Social Media',        recentPrices: [538,534,530,526,522,519,516,514,517,520,522,525,527],              context: 'Operates Facebook, Instagram, and WhatsApp while investing heavily in AI and the metaverse.',                 confidenceReason: 'Moderate confidence: MA cross is valid but price has been pulling back from highs — needs volume to confirm.',              rsVsSpy: -0.50 },
];
...
export const MOCK_AOTD_HISTORY = [
  ...
  { date: 'Mar 25', ticker: 'META', name: 'Meta Platforms',         type: 'ma_cross',  alertPrice: 527.40, alertChange: 1.22, confidence: 68, signal: '9MA crossed above 21MA',         nextDayClose: 533.87, outcome: 1.23 },
  { date: 'Mar 24', ticker: 'CRWD', name: 'CrowdStrike Holdings',   type: 'ma_cross',  alertPrice: 334.50, alertChange: 1.87, confidence: 72, signal: 'Bullish 9/21 MA cross on avg volume',  nextDayClose: 340.18, outcome: 1.70 },
...
export const BADGE_CONFIG = {
  '52w_high':    { color: '#D97706', bg: '#FFFBEB', border: 'rgba(217,119,6,0.25)',   label: '⚡ 52W High (5%)',       shortLabel: '52W High'    },
  'vol_surge':   { color: '#7C3AED', bg: '#F5F3FF', border: 'rgba(124,58,237,0.25)',  label: '🔥 Vol Surge (2x Avg)',  shortLabel: 'Vol Surge'   },
  'gap_up':      { color: '#16A34A', bg: '#F0FDF4', border: 'rgba(22,163,74,0.25)',   label: '📈 Gap Up (1.5%)',       shortLabel: 'Gap Up'      },
  'ma_cross':    { color: '#2563EB', bg: '#EFF6FF', border: 'rgba(37,99,235,0.25)',   label: '🔀 MA Cross (9/21)',     shortLabel: 'MA Cross'    },
  'vcp':         { color: '#EC4899', bg: '#FDF2F8', border: 'rgba(236,72,153,0.25)',  label: '📐 VCP Pattern',         shortLabel: 'VCP'         },
  'flow_signal': { color: '#F59E0B', bg: '#FFFBEB', border: 'rgba(245,158,11,0.25)',  label: '💰 Big Money',           shortLabel: 'Big Money'   },
};
